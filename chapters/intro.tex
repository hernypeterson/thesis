...
\begin{enumerate}
    \item Are discordant lava features consistent with surface deformation resulting from magma reservoir pressure change?
...
\begin{enumerate}
    \item The most discordant features will record a coherent (possibly non-unique) regional tilt pattern. Broader datasets dominated by low-discordance features will be less coherent and more error-prone.
    \item Regional tilt signatures will be possible to explain under a simplified model of reservoir pressure change.  
    \item Following the suggestion of \textcite{mouginis-mark_late-stage_2019}, post-caldera-collapse inflation in the southern summit region will best account for the most discordant flows.
\end{enumerate}