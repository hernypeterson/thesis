...
\acs{tilt}
    ...
    -\arctan\left(\dfrac{\acs{disp_z'}}{1+\acs{disp_r'}}\right),\label{eq:mogi-tilt}
\end{equation}
...
Differentiating Equations~\eqref{eq:uz_mogi} and~\eqref{eq:ur_mogi}, substituting into Equation~\eqref{eq:mogi-tilt}, and simplifying:
\begin{equation}
