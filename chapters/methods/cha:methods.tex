...
In this chapter, I introduce key considerations which inform subsequent methods (Section~\ref{sec:considerations}) and define the study area (Section~\ref{sec:study-area}).
...
\input{chapters/methods/sec:numerical-refinements.tex}