...
% TODO: include comparison between modern topo transect and paleo-spline transect

% also note center of paleo-topo spline; both are offset to the south from caldera complex center
...
% todo: add inset box to larger fig
...
The physical conditions assumed in this analytical model (deep, point-like reservoir in an elastic half-sapce) are not necessarily met even within numerical models, much less the physical edifice of Olympus Mons. However, this solution serves two important roles in the subsequent analysis. 
