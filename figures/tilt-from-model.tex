...
\begin{tikzpicture}[scale=1]
    ...
    % red tilt angle
    \draw[red,arrow,ultra thick] (B1) + (166:5) arc (166:149.5:5);
    \path (B1) + (158:5.4) node {\acs{tilt}};

    % element surface lines
    \draw[dashed, ultra thick, green!70!black] (A2_trans) -- (B1);
    \draw[ultra thick, blue] (A1) -- node[sloped,fill=white] {\textcolor{black}{Initial Surface}} (B1);
