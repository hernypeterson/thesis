...
My hypotheses follow, with a trend toward increasing speculation for the later-stage research questions:\begin{enumerate}
    ...
    \item based on preliminary inspection of the study area topography, (Figure~\ref{fig:study-area}) lava flow and channel deflection will reveal concentrated deformation at the southern flank, with minimal change elsewhere;
