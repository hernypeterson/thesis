...
\tdplotdrawarc[thick]{(O)}{0.5}{0}{\phivec}{anchor=north}{$\vartheta$}
...
\tdplotdrawarc[tdplot_rotated_coords,thick]{(0,0,0)}{0.45}{\thetavec}{0}{anchor=west}{$\varphi$}
...
\tdplotdrawarc[thick]{(O)}{0.4}{0}{330}{anchor=north east}{$\vartheta'$}

\tdplotdrawarc[tdplot_rotated_coords,thick,red]{(0,0,0)}{0.45}{0}{14.4523587}{anchor=south}{$\varphi'$}
