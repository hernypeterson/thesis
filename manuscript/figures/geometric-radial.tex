    ...
    \begin{tikzpicture}[scale=10,tdplot_main_coords]
        ...
        % fill THETA surface
        \filldraw[tdplot_rotated_coords, color = black, opacity = 0.05] (-50:\radius) arc (-50:50:\radius) -- (0,0.76604444*\radius) -- (0,-0.76604444*\radius);
        \filldraw[tdplot_rotated_coords, color = red, opacity = 0.3] (\zenproj:\radius) arc (\zenproj:\zeproj:\radius) -- (0,0);     

        % line THETA surface
        \tdplotdrawarc[arrow, tdplot_rotated_coords, very thick]{(O)}{\radius}{-50}{50}{}{}
