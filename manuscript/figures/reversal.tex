\begin{tikzpicture}[scale=2.6,tdplot_main_coords]
        ...
        % z-axis
        \draw[arrow] (O) -- (0,0,\axislength) node[anchor=south]{$z=\acs{normal'}$};
        
        % |az' - az| angle label
        \tdplotdrawarc{(O)}{0.6}{\azi}{\azrev-360}{anchor=north}{$\acs{az'}-\acs{az}$}
        
        % ze angle label
        \tdplotdrawarc[tdplot_rotated_coords]{(O)}{\radius}{0}{\ze}{coordinate, pin={[pin edge={black},-]-90:$\acs{ze}=\acs{central-angle}$}}{}
