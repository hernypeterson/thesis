...
% az angle label
\tdplotdrawarc{(O)}{0.4*\radius}{\az}{90}{pin={[pin edge={black},pin distance=1cm,-]-60:\acs{az}}}{}

% az surface
\tdplotsetthetaplanecoords{\az}

% ze angle label
\tdplotdrawarc[tdplot_rotated_coords]{(O)}{0.4*\radius}{0}{\ze}{pin={[pin edge={black},-]80:\acs{ze}}}{}

% ze angle label
\tdplotdrawarc[tdplot_rotated_coords]{(O)}{0.4*\radius}{90}{90+\ze}{pin={[pin edge={black},-]180:\acs{ze}}}{}
