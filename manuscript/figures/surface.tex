\begin{tikzpicture}[scale=3.1,tdplot_main_coords]
...
\draw[tdplot_rotated_coords] (0.2,0,0) -- (0.2,0,0.2) -- (0,0,0.2) -- (0,-0.2,0.2) -- (0,-0.2,0);

% horizontal surface (front left)
\fill[color = gray!10!white, opacity=0.6] (\az-90:0.5*\radius) arc (\az-90:\az:0.5*\radius) -- (0,0);

% cartesian axes
\draw[arrow] (O) -- (0,0.4*\axislength,0) node[anchor=west]{\acs{north}};
...
% az angle label
\tdplotdrawarc{(O)}{0.4*\radius}{\az}{90}{coordinate, pin={[pin edge={black},-]-60:\acs{az}}}{}

% az surface
\tdplotsetthetaplanecoords{\az}

% ze angle label
\tdplotdrawarc[tdplot_rotated_coords]{(O)}{0.4*\radius}{0}{\ze}{coordinate, pin={[pin edge={black},-]80:\acs{ze}}}{}

% ze angle label
\tdplotdrawarc[tdplot_rotated_coords]{(O)}{0.4*\radius}{90}{90+\ze}{coordinate, pin={[pin edge={black},-]180:\acs{ze}}}{}
